            ...
            <div className="flex justify-between h-16">
              <div className="flex">
                ...
                <div className="hidden md:ml-6 md:flex md:space-x-8">
                  ...
                  <a
                    href="#"
                    className="border-secondary text-text inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium"
                  >
                    HOME
                  </a>
                  <a
                    href="#"
                    className="border-transparent  text-text  hover:border-gray-300 hover:text-gray-700 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium"
                  >
                    ABOUT
                  </a>
                  <a
